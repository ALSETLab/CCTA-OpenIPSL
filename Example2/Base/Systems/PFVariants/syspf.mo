within Example2.Base.Systems.PFVariants;
model syspf "Power system model with input/output interfaces"
  ...
  replaceable record Bus = PFData.Data.BusData.PF_Bus_0 constrainedby
    Example2.PFData.Data.BusData.Bus_Template                                                                   annotation (
  ...
  replaceable record Loads = PFData.Data.LoadData.PF_Loads_0 constrainedby
    Example2.PFData.Data.LoadData.Loads_Template                                                                        annotation (
      choicesAllMatching=true,Dialog(group="Power Flow Data", tab="Power Flow Scenario"));
  replaceable record Trafos = PFData.Data.TrafoData.PF_Trafos_0 constrainedby
    Example2.PFData.Data.TrafoData.Trafos_Template                                                                           annotation (
      choicesAllMatching=true,Dialog(group="Power Flow Data", tab="Power Flow Scenario"));
  replaceable record Machines = PFData.Data.MachineData.PF_Machines_0 constrainedby
    Example2.PFData.Data.MachineData.Machines_Template
