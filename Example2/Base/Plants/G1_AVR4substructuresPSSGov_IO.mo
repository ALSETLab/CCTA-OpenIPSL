...
model G1_AVR4substructuresPSSGov_IO "This model includes a pss \"container\" with 4 sub-structures, each of which is activated/deactivated at specific points in time"
  ...
  CustomComponents.PSSChangeParam.PSS4Substructures pss(
    t1=t1pssin,
    t2=t2pssin,
    t3=t3pssin,
    t4=t4ppsin,
...
end G1_AVR4substructuresPSSGov_IO;
