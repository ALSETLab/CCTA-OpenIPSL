...
<p>In contrast, the voltage mangitude is defined in <a href=\"Example2.Base.Systems.Basic.Data.PF_TwoAreas.Voltages\">Example2.Base.Systems.Basic.Data.PF_TwoAreas.Voltages</a> as:</p>
...
<p>It is recommended that the approach used within this package is favored. The other package is used to illustrate the point discussed above and for the sake of reproducibility of the work in [2].</p>
