...
<p><i><b>Models:</b></i></p>
<ol>
<li>Example2.Analysis.Ramping, illustrates how to simulate multiple operating conditions by ramping g1 and Load9 in Example2.Base.Systems.sys</li>
<li>Example2.Analysis.RampingRandomLoadAndInput, illustrates how to add multisine input signal and random load variations (in addition to ramping) to the system in Example2.Base.Systems.sys.</li>
<li>Example2.Analysis.KchangeLinRamping, designed to linearize the model Example2.Base.Systems.sys at any point in time while considering ramping as in Example2.Analysis.Ramping</li>
</ol>
