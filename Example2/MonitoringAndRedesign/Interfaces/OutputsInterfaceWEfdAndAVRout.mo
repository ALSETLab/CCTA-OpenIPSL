...
public
  ...
  Modelica.Blocks.Interfaces.RealOutput Q
    annotation (Placement(transformation(extent={{300,30},{320,50}}),
        iconTransformation(extent={{300,30},{320,50}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput delta
    annotation (Placement(transformation(extent={{300,-50},{320,-30}}),
        iconTransformation(extent={{300,-50},{320,-30}})));
  Modelica.Blocks.Interfaces.RealOutput AVRin annotation (Placement(
        transformation(extent={{300,-90},{320,-70}}),
        iconTransformation(extent={{300,-90},{320,-70}})));
  Modelica.Blocks.Interfaces.RealOutput AVRout annotation (Placement(
        transformation(extent={{300,-130},{320,-110}}),
        iconTransformation(extent={{300,-130},{320,-110}})));
