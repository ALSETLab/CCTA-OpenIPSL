...
model SysDetuned4SubstructurePSSTGRev "This model includes a pss \"container\" with 4 sub-structures"
  ...
  Plants.G1_AVR4substructuresPSSGov_IO_rev
                      g1(
    ...
    pss3_Tw=pss3_Tw,
    pss4_Kw=pss4_Kw,
    pss4_Tw=pss4_Tw)               annotation (Placement(transformation(extent={{-268,8},{-234,138}})));
  ReferenceSimulationModels.Groups.PSSE.AVR.G2_sexs    g2_sexs(
  ...
  ReferenceSimulationModels.Groups.PSSE.TgAVR.G3
                                              g3(
    ...
    Rdroop=0.025,
    tGTypeII(T3=Modelica.Constants.small))
                                  annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=180,
        origin={268,16})));
  ReferenceSimulationModels.Groups.PSSE.AVR.G4_sexs    g4_sexs(
  ...
  parameter Real t4ppsin=90 "Stop time of the injection" annotation (Dialog(tab="PSS Parameters",group="PSS Parameter Change Timing"));
  parameter Real t5pssStop=Modelica.Constants.inf "Stop time of the injection" annotation (Dialog(tab="PSS Parameters",group="PSS Parameter Change Timing"));
...
equation
  ...
  connect(Line5_2.n, Line5_2B.p) annotation (Line(points={{-191,-14},{-192,-14},{-192,-38},{-184,-38},{-184,-44},{-175,-44}}, color={0,0,255}));
...
<p>Compare these results with the ones from <strong>Two_Areas_PSSE_AVR</strong>.</p>
    ...
    Icon(graphics={Text(
        ...
        Text(
          ...
          textString="Seq.PSS")}));
end SysDetuned4SubstructurePSSTGRev;
