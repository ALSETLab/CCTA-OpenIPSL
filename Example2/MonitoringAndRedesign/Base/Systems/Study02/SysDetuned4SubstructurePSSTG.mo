...
model SysDetuned4SubstructurePSSTG "This model includes a pss \"container\" with 4 sub-structures"
  ...
  Plants.G1_AVR4substructuresPSSGov_IO
                      g1(
...
<p>Compare these results with the ones from <strong>Two_Areas_PSSE_AVR</strong>.</p>
    ...
    Icon(graphics={Text(
        ...
        Text(
          ...
          textString="Seq.PSS")}));
end SysDetuned4SubstructurePSSTG;
