...
model SysDtunedG14sstPSSTGRevG3plusPSS "This model includes a pss \"container\" with 4 sub-structures"
  ...
  ReferenceSimulationModels.Groups.PSSE.TgAVRPSS.G3
                                              g3(
...
equation
  ...
  connect(g1.pwPin,bus1. p) annotation (Line(points={{-234,75},{-230,75},{-230,16},{-220,16}},
                color={0,0,255}));
  ...
  connect(g1.uPm, uPm) annotation (Line(
      points={{-270.267,92.3333},{-276,92.3333},{-276,120},{-298,120}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(g1.uPSS, uPSS) annotation (Line(
      points={{-270.267,75},{-270.267,72},{-274,72},{-274,60},{-300,60}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(g1.uVsAVR, uAVRin) annotation (Line(
      points={{-270.267,57.6667},{-270.267,54},{-274,54},{-274,0},{-300,0}},
      color={0,0,127},
      smooth=Smooth.Bezier));
