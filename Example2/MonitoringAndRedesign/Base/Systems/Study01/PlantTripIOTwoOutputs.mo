...
model PlantTripIOTwoOutputs "11-bus 4-machine 2-area test system implemented with machine models from PSSE"
  extends Example2.Utilities.Icons.ModelForLinearization;
  extends Example2.MonitoringAndRedesign.Interfaces.OutputsInterfaceTwoOutputs;
  parameter Real r=0.0001;
  parameter Real x=0.001;
  parameter Real b=0.00175*0.5;
  Modelica.Blocks.Interfaces.RealInput uPm
    annotation (Placement(transformation(extent={{-318,100},{-278,140}})));
  ...
  OpenIPSL.Electrical.Branches.PwLine Line9_10_B(
    ...
    X=0.007333333333333,
    G=0,
    B=0) annotation (Placement(transformation(extent={{90,16},{110,36}})));
  ...
  OpenIPSL.Electrical.Branches.PwLine Line6_7_A2(
    ...
    X=0.02,
    G=0,
    B=0) annotation (Placement(transformation(extent={{-98,-4},{-78,16}})));
  ...
  parameter OpenIPSL.Types.Time t1=0.5
  ...
  parameter OpenIPSL.Types.PerUnit vsmin=-0.2 "Min stabilizer output signal"
    annotation (Dialog(group="PSS Parameters"));
  parameter Real Kw=200 "Stabilizer gain [pu/pu]"
    annotation (Dialog(group="PSS Parameters"));
  parameter OpenIPSL.Types.Time Tw=10 "Wash-out time constant"
    annotation (Dialog(group="PSS Parameters"));
  parameter OpenIPSL.Types.Time T1=0.05 "First stabilizer time constant"
    annotation (Dialog(group="PSS Parameters"));
  parameter OpenIPSL.Types.Time T2=0.02 "Second stabilizer time constant"
    annotation (Dialog(group="PSS Parameters"));
  parameter OpenIPSL.Types.Time T3=3.0 "Third stabilizer time constant"
    annotation (Dialog(group="PSS Parameters"));
  parameter OpenIPSL.Types.Time T4=5.4 "Fourth stabilizer time constant"
    annotation (Dialog(group="PSS Parameters"));
...
//  AVRout = g1.AVRoutput_meas; // AVR output, Efd
  ...
  connect(Line9_10_A.n,bus10. p)
    annotation (Line(points={{147,16},{160,16}}, color={0,0,255}));
  ...
  connect(Load9.p,bus9. p)
    annotation (Line(points={{65,-14},{65,16},{60,16}},
                                                      color={0,0,255}));
  connect(Line9_10_A.p,Line9_10_B. n) annotation (Line(points={{129,16},{116,16},
          {116,26},{109,26}}, color={0,0,255}));
  connect(Line9_10_C.n,Line9_10_B. n) annotation (Line(points={{109,4},{116,4},
          {116,26},{109,26}}, color={0,0,255}));
  connect(Line9_10_C.p,Line9_10_B. p) annotation (Line(points={{91,4},{80,4},{
          80,26},{91,26}},  color={0,0,255}));
  connect(bus9.p,Line9_10_B. p) annotation (Line(points={{60,16},{80,16},{80,26},
          {91,26}}, color={0,0,255}));
