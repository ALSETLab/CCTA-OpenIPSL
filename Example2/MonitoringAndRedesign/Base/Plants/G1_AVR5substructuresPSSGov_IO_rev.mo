...
model G1_AVR5substructuresPSSGov_IO_rev "This model includes a pss \"container\" with 5 sub-structures, each of which is activated/deactivated at specific points in time"
  ...
  Analysis.CustomComponents.PSSChangeParam.PSS5Substructures pss(
    t1=t1pssin,
    t2=t2pssin,
    t3=t3pssin,
    t4=t4pssin,
    ...
    pss4_Kw=pss4_Kw,
    pss4_Tw=pss4_Tw,
    pss5_vsmax=pss_vsmax,
    pss5_vsmin=pss_vsmin,
    pss5_Kw=pss5_Kw,
    pss5_Tw=pss5_Tw) annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  ...
  parameter Real t4pssin = 90 "Start time of the injection" annotation (Dialog(group="PSS Parameter Change Timing"));
  parameter Real t5pssin = Modelica.Constants.inf "Start time of the injection" annotation (Dialog(group="PSS Parameter Change Timing"));
  parameter Real t6pssStop=Modelica.Constants.inf "Stop time of the injection" annotation (Dialog(group="PSS Parameter Change Timing"));
