...
model LoadAndInputSignalSimulation_CaseB_newmultisine20221024_higherLoadNoise
...
equation
  ...
  connect(uL7_timedNoiseInjection.y, plantTripIO.uLoad7) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(timedInputInjection_CaseB.y, plantTripIO.uAVRin) annotation (Line(
...
end LoadAndInputSignalSimulation_CaseB_newmultisine20221024_higherLoadNoise;
