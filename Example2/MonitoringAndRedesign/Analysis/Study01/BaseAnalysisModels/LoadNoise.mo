...
model LoadNoise
  ...
  CustomComponents.TimedNoiseInjection uL7_timedNoiseInjection1(
    samplePeriod=0.01,
    sigma=0.0025,
    threshold=0.1)
...
equation
  ...
  connect(Pmchange.y, plantTripIO.uPSS) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(AVRchange.y, plantTripIO.uAVRin) annotation (Line(
      points={{-190,59},{-190,22},{-92,22}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(uL7_timedNoiseInjection1.y, plantTripIO.uLoad9) annotation (Line(
      points={{-179,-30},{-150,-30},{-124,-30},{-124,6},{-92,6},{-92,5.2}},
      color={0,0,127},
      smooth=Smooth.Bezier));
