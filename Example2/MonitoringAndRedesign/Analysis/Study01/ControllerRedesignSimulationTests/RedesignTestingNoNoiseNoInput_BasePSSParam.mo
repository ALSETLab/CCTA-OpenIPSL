...
model RedesignTestingNoNoiseNoInput_BasePSSParam
  ...
  Base.Systems.Study01.PlantTripIO plantTripIO(t1busfault=120, t2busfault=120 + 3/60) annotation (Placement(transformation(extent={{-64,8},{-36,36}})));
...
end RedesignTestingNoNoiseNoInput_BasePSSParam;
