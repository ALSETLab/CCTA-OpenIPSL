...
model KchangeLinRamping "Model to perform blind estimation with default controller and re-design"
  ...
  Base.Systems.Study02.SysDetuned4SubstructurePSSTGRev
    ...
    pss4_Tw=1.28453193073444)                                           annotation (Placement(transformation(extent={{60,-40},{140,40}})));
  ...
  CustomComponents.TimedMultiRamp ramping(
    ...
    rampB_height=0.125,
    rampC_height=-0.25,
    rampD_height=-0.25) annotation (Placement(transformation(
        rotation=270,
        extent={{-20,-20},{20,20}},
        origin={0,118})));
equation
