within Example2.MonitoringAndRedesign.Analysis.Study02.Scenarios.SequentialPSS;
model NoiseAndInput "Model to perform blind estimation with default controller and re-design"
  extends Modelica.Icons.Example;
  Base.Systems.Study02.SysDetuned4SubstructurePSSTG
                                                plant(g1(Rdroop=0.025),
    t2pssin=1200,
    t3pssin=2100,
    t4ppsin=3000,
    pss2_Kw=147.264701063834,
    pss2_Tw=19.8529892248624,
    pss3_Kw=138.273311137103,
    pss3_Tw=19.9000965642166)                                           annotation (Placement(transformation(extent={{58,-40},{138,40}})));
  ...
  CustomComponents.TimedNoiseInjection uL9(
    samplePeriod=0.01,
    sigma=0.1*0.25,
    threshold=30)  annotation (Placement(transformation(extent={{-180,-142},{-140,-102}})));
...
equation
  ...
  connect(uL9.y,add. u1) annotation (Line(
      points={{-138,-122},{-130,-122},{-130,-128},{-114,-128}},
      color={0,140,72},
      thickness=1));
