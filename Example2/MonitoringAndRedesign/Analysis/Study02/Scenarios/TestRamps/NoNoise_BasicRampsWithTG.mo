...
model NoNoise_BasicRampsWithTG
  ...
  Base.Systems.Study02.SystemIODetunedPSSwithTG plant(g1(Rdroop=0.025)) annotation (Placement(transformation(extent={{46,-14},{74,14}})));
