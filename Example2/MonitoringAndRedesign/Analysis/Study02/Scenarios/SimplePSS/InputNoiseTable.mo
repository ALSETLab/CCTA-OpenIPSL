...
model InputNoiseTable
  ...
  CustomComponents.TimedInjectionOnOffTableData r annotation (Placement(transformation(extent={{-140,-62},{-98,-20}})));
equation
  ...
  connect(r.y, plant.uAVRin) annotation (Line(
      points={{-94.64,-41},{-58,-41},{-58,0},{33.2,0}},
      color={217,67,180},
      thickness=1));
  annotation (
        experiment(
