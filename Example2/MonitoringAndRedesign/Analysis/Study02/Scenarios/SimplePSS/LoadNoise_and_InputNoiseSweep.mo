...
model LoadNoise_and_InputNoiseSweep
  ...
  CustomComponents.TimedInjectionOnOffVariablefreqSine
                                                r annotation (Placement(transformation(extent={{-142,-22},{-100,20}})));
...
end LoadNoise_and_InputNoiseSweep;
