within Example2.MonitoringAndRedesign.Analysis.Study02.Scenarios.SimplePSS;
model InputNoiseSine
  ...
  CustomComponents.TimedInjectionOnOff r annotation (Placement(transformation(extent={{-140,-62},{-98,-20}})));
  Modelica.Blocks.Sources.Sine sine(amplitude=0.005, f=0.8) annotation (Placement(transformation(extent={{-194,-60},{-154,-20}})));
equation
  ...
  connect(sine.y, r.u) annotation (Line(points={{-152,-40},{-156,-41},{-142.1,-41}}, color={0,0,127}));
  connect(plant.uAVRin, r.y) annotation (Line(
      points={{33.2,0},{-58,0},{-58,-41},{-94.64,-41}},
      color={217,67,180},
      thickness=1));
  annotation (
        experiment(
