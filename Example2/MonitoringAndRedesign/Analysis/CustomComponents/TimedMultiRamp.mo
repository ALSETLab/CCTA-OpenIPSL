...
model TimedMultiRamp
  ...
  CustomComponents.MultiRamp multiRamp(
    ...
    foh_samplePeriod=foh_samplePeriod) annotation (Placement(transformation(extent={{-80,-20},{-40,20}})));
  CustomComponents.TimedInjection timedInjection(timedinjection_threshold=timedinjection_threshold)
