...
model PSS4Substructures
  ...
  Example2.MonitoringAndRedesign.Analysis.CustomComponents.TimedInputInjectionOnOff
    t1_t2(t_start=t1, t_stop=t2)
  ...
  Example2.MonitoringAndRedesign.Analysis.CustomComponents.TimedInputInjectionOnOff
    t2_t3(t_start=t2, t_stop=t3)
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  Example2.MonitoringAndRedesign.Analysis.CustomComponents.TimedInputInjectionOnOff
    t3_t4(t_start=t3, t_stop=t4)
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  Example2.MonitoringAndRedesign.Analysis.CustomComponents.TimedInputInjectionOnOff
    t4_t5(t_start=t4, t_stop=t5)
