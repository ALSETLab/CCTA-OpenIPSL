...
<p>To simulate and plot the results shown below, execute the the function <span style=\"font-family: Courier New;\"><a href=\"Example2.Analysis.AutomationFunctions.simulate_and_plot_ramping\">Example2.Analysis.AutomationFunctions.simulate_and_plot_ramping</a>,</span>following the instructions below.</p>
