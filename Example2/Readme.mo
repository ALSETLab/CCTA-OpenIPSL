...
<p>To simulate and plot the results shown below, execute the the function <span style=\"font-family: Courier New;\"><a href=\"modelica://Example2.Analysis.AutomationFunctions.simulate_and_plot_ramping\">Example2.Analysis.AutomationFunctions.simulate_and_plot_ramping</a>,</span>following the instructions below.</p>
<p><img src=\"modelica://Example2/Resources/simulate_and_plot_ramping.png\"/></p>
<p>Observe that the plot above is very similar to that in Fig. 4 of [2]. To reproduce the results in Fig. 4 of [2], execute the function <span style=\"font-family: Courier New;\"><a href=\"modelica://Example2.Analysis.AutomationFunctions.simulate_and_plot_inputs\">Example2.Analysis.AutomationFunctions.simulate_and_plot_inputs</a></span> , which runs the model <span style=\"font-family: Courier New;\">Example2.Analysis.RampingRandomLoadAndInput</span>.</p>
...
<p>An additional function, <span style=\"font-family: Courier New;\"><a href=\"modelica://Example2.Analysis.AutomationFunctions.linearize_KchangeLinRamping\">Example2.Analysis.AutomationFunctions.linearize_KchangeLinRamping</a></span>, allows to linearize the model <span style=\"font-family: Courier New;\">Example2.Analysis.KchangeLinRamping</span> at any point in time while at the same time running the same simulation scenario as in the &quot;Ramping&quot; example above. Running the function outputs a linear model.</p>
