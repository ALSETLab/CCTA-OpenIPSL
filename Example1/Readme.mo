...
<ul>
<li><a href=\"
Example1.Analysis.LinearAnalysis\">LinearAnalysis</a>, provides models and functions to illustrate how to perform linearization on a model, simulate the linear model and compare it against the response of a nonlinear model. These tasks are automated executing the function <a href=\"Example1.Analysis.LinearAnalysis.CustomFunctions.LinearizeAndCompare\">LinearizeAndCompare</a>, which will help to reproduce the results shown in Fig. 6 of [1]. See more information in the documentation/info layer of the function.</li>
