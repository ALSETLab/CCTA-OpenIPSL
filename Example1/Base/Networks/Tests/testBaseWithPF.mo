...
model testBaseWithPF "Tes model for BaseWithPF network"
  ...
  extends BaseWithPF(pf(
      ...
      redeclare record Machines =
          Example1.PFData.Data.MachineData.PF_Machines_5), infiniteBus(
      P_0=pf.machines.PG2,
      Q_0=pf.machines.QG2,
      v_0=pf.bus.V3,
      angle_0=pf.bus.A3));
...
equation
  ...
  connect(const.y, load_ExtInput.u) annotation (Line(points={{1,-70},{12,-70},{
          12,-66.7},{17.14,-66.7}}, color={0,0,127}));
